...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    umbrud.spawn.datadir.should.equal(home + '/.umbru');
    umbrud.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.umbru/umbrud'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.umbrud.spawn.datadir.should.equal('./data2');
  });
});
