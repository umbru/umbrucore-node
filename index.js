...
module.exports.services.Umbru = require('./lib/services/umbrud');
...
module.exports.cli.umbrucore = require('./lib/cli/umbrucore');
module.exports.cli.umbrucored = require('./lib/cli/umbrucored');

module.exports.lib = require('umbrucore-lib');
